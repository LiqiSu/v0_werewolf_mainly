...
def build_prompt(player_action):
    ...
    system_instructions = (
        ...
        "Write in second-person POV, addressing the player as 'you'.\n"
    ...
    full_prompt = (
        ...
        "Continue the story in second-person POV, describing the consequences of this action, "
...
def main():
    ...
    print("You are the player character. Speak and act in first person (I ...).")
    print("Example: 'I step into the ruins and call out.'")
    print("Type 'exit' to quit.\n")

    while True:
        player_action = input("You (your character's action or words): ")
        if player_action.lower().strip() == "exit":
            break

        story_output = generate_story(player_action)
